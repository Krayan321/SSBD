...
$WAR = Get-ChildItem -Path "$PROJECT_ROOT\target" *.war
...
asadmin --host 10.31.201.3 --port 4848 --user admin --passwordfile "$PROJECT_ROOT\config\payara-password" redeploy --name "ssbd01" "$PROJECT_ROOT\target\ssbd01-0.0.1.war"
