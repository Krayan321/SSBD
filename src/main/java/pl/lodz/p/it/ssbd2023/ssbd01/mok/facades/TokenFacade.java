...
public class TokenFacade extends AbstractFacade<Token> {
    ...
    public Token findByAccount(Long id) {
        TypedQuery<Token> tq =
                em.createNamedQuery("token.findByAccountId", Token.class);
    ...
    public List<Token> findByTypeAndBeforeGivenData(TokenType type, Date date) {
        TypedQuery<Token> tq =
                em.createNamedQuery(
                        "token.findByTypeAndBeforeGivenDataAndNotUsedAndNotPreviouslySent",
                        Token.class);
    ...
    public Token findByCode(String code) {
        TypedQuery<Token> tq =
                em.createNamedQuery("token.findByCode", Token.class);
