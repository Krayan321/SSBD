...
@NamedQuery(name = "token.findByTypeAndBeforeGivenDataAndNotUsedAndNotPreviouslySent",
        query = "SELECT o FROM Token o WHERE o.tokenType = ?1 " +
...
public class Token extends AbstractEntity {
    ...
    @NotNull
    @Column(name = "was_previous_token_sent", nullable = false, columnDefinition = "boolean default false")
